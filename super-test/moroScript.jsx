  ...
  render: function() {
    ...
    if (this.state.story_view) {
      if (this.state.french_view) {
        ...
        language = 'English';
        // sentenceInfo = <Sentence sentence={x.value.sentence}
  ...
  render: function() {
    ...
    <div className='ui borderless main menu fixed' styleName='position: fixed; top: 0px; left: auto; z-index: 1;'>
        <div className='ui text container'>
          ...
          <div className='item'>
            <div className="ui slider checkbox">
            <input type="radio" name="toggle_lang" checked={this.state.showFrench} onChange={this.toggleLang}> </input>
