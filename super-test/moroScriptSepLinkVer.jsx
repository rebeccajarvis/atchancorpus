...
//=========================HOMEPAGE===============================
    return   <div className='ui text container'> 
        ...
        <h1 className='ui dividing header'>Atchan Story Corpus</h1>

        <img className="ui medium right floated rounded image" src="./images/Nuba-berge.jpg"></img>
    
    <p>This website contains a collection of texts, songs, and stories in the Atchan language.  
       Atchan (also called Ébrié) is a language spoken by the Tchaman people, who live in and near the city of Abidjan, Côte d’Ivoire.
       Atchan is a Potou language, in the Kwa (and broader Niger-Congo) language family.  
       Through the texts on this page, you can learn more about the Tchaman people, their culture, and their traditional stories.</p> 
    
      <p>This website is intended as a resource for Tchaman people and for researchers who are interested in learning more about the Atchan language.  The orthography for Atchan was developed by Prof. Yao Maxime Dido, a Tchaman linguist and professor, and Prof. Rémy Bôle-Richard.</p>
      
      <p>This site is a collaboration between Maxime Dido and UC Berkeley linguists.</p>
...
//=========================HOMEPAGE===============================
  ...
  <p>Ce site web contient une collection de textes, de chansons et de contes en langue atchan. L’atchan (aussi appelé l’ébrié) est une langue parlée par le peuple Tchaman, qui vit dans et à proximité de la ville d’Abidjan, en Côte d’Ivoire.  L’atchan est une langue potou de la famille kwa (niger-congo). Avec les textes de cette page, vous pourrez en apprendre plus sur le peuple Tchaman, sa culture et ses histoires traditionnelles.
  </p> 
  
    <p>Ce site web est conçu comme une ressource pour le peuple Tchaman et pour les chercheurs qui souhaitent en savoir plus sur la langue atchan. L’orthographe d’atchan a été développée par Prof. Yao Maxime Dido, linguiste Tchaman et professeur à l’Université Alassane Ouattara de Bouaké, et Prof. Rémy Bôle-Richard.</p>
    
    <p>Ce site web est une collaboration entre Maxime Dido et des linguistes de l’Université de Californie à Berkeley.</p>
